                        ...
                        <form action="{{route('harga.store')}}" method="post">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('tanggal') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="tanggal" id="input-tanggal" class="form-control datepicker form-control-alternative{{ $errors->has('tanggal') ? ' is-invalid' : '' }}" placeholder="{{ __('Masukkan Tanggal') }}" value="{{ old('tanggal') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('harga') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="harga" id="input-harga" class="form-control form-control-alternative{{ $errors->has('harga') ? ' is-invalid' : '' }}" placeholder="{{ __('Masukkan Harga') }}" value="{{ old('harga') }}" required>
